...
const cardInfo = [
    {
        img: cardBg01,
        title: "웹표준 사이트 만들기",
        desc: "사이트를 만들기 위한 기초 강의입니다. 기본 코딩에 대한 감각을 익히고, 웹 표준을 준수하면서 코딩하는 방법을 익힙니다. 다양한 예제를 통해 사이트를 만드는 방법",
    },
    {
        img: cardBg02,
        title: "반응형 사이트 만들기",
    ...
    },
    {
        img: cardBg03,
        title: "패랠렉스 사이트 만들기",
        desc: "기업 사이트 중 50% 이상이 패랙렉스 스크로링 효과로 만들어져 있습니다. 웹 표준, 반응형 사이트를 완성했다면 이제는 인터랙티브한 패랠렉스 스크롤링 사이트를...",
    },
]

const Card = ( props ) => {
    return (
        <section id="cartType" className={`card__wrap ${props.element}`}>
            <h2>{props.title}</h2>
            <p>
            ...
            <div className="card__inner container">
                {cardInfo.map((card, key) => (
                    ...
                    <figure className="card__header">
                        <img src={card.img} alt="웹표준 사이트 만들기" />
                    </figure>
